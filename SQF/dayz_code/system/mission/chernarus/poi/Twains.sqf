...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 0.15];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 0.2];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 0.19];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 1.3];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 0.16];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _vehicle_72 = _this;
  _this setDir -1.726;
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 0.91]; _this setvectordirandup [[-0.1,4,-0.055],[0,0,1]];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 1.32];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 1.35];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 1.34];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 1.31];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 0.21];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 0.205];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 0.18];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 0.22];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 0.144];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 0.147];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 0.173];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 0.155];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)- 1.3 ]; _this setvectordirandup [[-1,-1,0],[-5,0,-1]];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _vehicle_200 = _this;
  _this setDir 185;
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)- 1.2 ]; _this setvectordirandup [[0,0.1,0],[-100,0,0]];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 0.6 ]; _this setvectordirandup [[-0.8,-0.9,0.3],[0,0.9,0.9]];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)- 0.1];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _vehicle_203 = _this;
  _this setDir -151.81;
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)- 0.3];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 0.14];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 0.45];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 0.395]; _this setvectordirandup [[1,0.24,0.023],[0,0,0.1]];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 0.85];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 0.72]; _this setvectordirandup [[-1,-0.444,0.016],[0,0,0.1]];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)- 1]; _this setvectordirandup [[-1,0,0],[5,-5,-1]];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)- 0.1]; _this setvectordirandup [[-0.9,-0.9,0.02],[0,0.005,0.1]];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 0.3];  _this setvectordirandup [[1,0.44,-0.015],[0,0,0.1]];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)- 1.2 ]; _this setvectordirandup [[-5.8,-0.9,0.2],[0,-0.9,0.2]];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 0.9]; _this setvectordirandup [[1,0.24,0.023],[0,0,0.1]];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 1.3]; _this setvectordirandup [[-1,-0.234,-0.003],[0,0,0.1]];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _vehicle_230 = _this;
  _this setDir 30;
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 0.4]; _this setvectordirandup [[0.1,0.04,0],[0,0.1,0.5]];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 0.9];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 0.93];  _this setvectordirandup [[1,0.44,0.016],[0,0,0.1]];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 1.18];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 1.24]; _this setvectordirandup [[1,0.06,-0.001],[0,0,0.1]];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 1.19];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 1.2];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 1.29]; _this setvectordirandup [[1,0.064,-0.001],[0,0,0.1]];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)- 0.1]; _this setvectordirandup [[-1,0.8,0],[-0.1,0,1]];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)- 0.6 ]; _this setvectordirandup [[-1.8,3,0],[0,-0.1,0.1]];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)- 0.6 ]; _this setvectordirandup [[0.1,-0.9,0.1],[0,-5.2,0.1]];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)- 0.3 ]; _this setvectordirandup [[0.5,0.1,0],[100,0,0]];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 1.208];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 1.222];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 1.225];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 1.205];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 0.5];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _vehicle_270 = _this;
  _this setDir 13.7257;
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)- 0.6 ]; _this setvectordirandup [[0.3,-5.9,0.3],[-0.1,0.9,0.6]];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)- 0.3]; _this setvectordirandup [[1,-0.3,0],[0,-0.15,0.1]];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)- 0.6 ]; _this setvectordirandup [[0.1,-5.9,0.3],[-0.5,0.9,0.6]];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)- 0.1]; _this setvectordirandup [[0,-1,-0.1],[0,-0.05,1]];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 0.35]; _this setvectordirandup [[1,-0.2,0.25],[-5,2,1]];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _vehicle_280 = _this;
  _this setDir 52.2078;
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)+ 0.31];  _this setvectordirandup [[-1,-0.8,-0.3],[0.1,0,1]];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _vehicle_281 = _this;
  _this spawn { uiSleep 1;if (isServer) then {_this setvectordirandup [[-0.5,-1,-0.15],[0,0,1]];}; };
...
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
  ...
  _vehicle_282 = _this;
  _this spawn { uiSleep 1;if (isServer) then {_this setpos [(getpos _this select 0), (getpos _this select 1), (getpos _this select 2)- 0.1]; _this setvectordirandup [[1,-1,0],[-15,0,-1]];}; };
