...
DZE_SafeZoneNoBuildNear = []; //Array of object class names that are blacklisted to build near. i.e ["Land_Mil_ControlTower","Land_SS_hangar"] etc.
DZE_SafeZoneNoBuildDistance = 1000; // Distance from safe zones listed above to disallow building near.
DZE_BlacklistNoBuildDistance = 1000; // Distance from blacklisted objects to disallow building near.
