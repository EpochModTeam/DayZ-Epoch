private ["_item","_picture","_class","_display","_transportMaxMagazines","_buyPrice","_sellPrice","_buyCurrency","_sellCurrency","_formattedText","_picBuy","_picSell"];
#include "defines.hpp"
...
if (Z_SingleCurrency) then {
	...
	_formattedText = format [
		...
		"<t color='#bcbcbc' size='0.7'>%9: </t><t color='#ffffff' size='0.7'>%2</t><br />" +
		"<t color='#bcbcbc' size='0.7'>%10: </t><t color='#ffffff' size='0.7'>%3</t><br />" +
		"<t color='#bcbcbc' size='0.7'>%12: </t><t color='#ffffff' size='0.7'>%6 <img image='%15' /> %4</t><br />" +
		"<t color='#bcbcbc' size='0.7'>%11: </t><t color='#ffffff' size='0.7'>%5 <img image='%14' /> %7</t><br />" +
		"<t color='#bcbcbc' size='0.7'>%16: </t><t color='#ffffff' size='0.7'><img image='%13'/> %8</t><br />",
		_picture,
		_display,
		_class,
		_buyCurrency,
