...
class SnapBuilding {
	...
	class MetalFloor_DZ: FloorsWallsStairs {
		points[] = {
			{0,0,0,$STR_EPOCH_ACTION_SNAP_PIVOT},
			{0, -2.63,0.1265,$STR_EPOCH_ACTION_SNAP_BACK},
			{0, 2.63,0.1265,$STR_EPOCH_ACTION_SNAP_FRONT},
			{-2.63,0,0.1265,$STR_EPOCH_ACTION_SNAP_LEFT},
			{2.63,0,0.1265,$STR_EPOCH_ACTION_SNAP_RIGHT}
		};
		radius = 12;
	};
	...
	class MetalFloor_Quarter_DZ: FloorsWallsStairs {
		points[] = {
			{0,0,0,$STR_EPOCH_ACTION_SNAP_PIVOT},
			{0,-1.2,0.1265,$STR_EPOCH_ACTION_SNAP_BACK},
			{0,1.42,0.1265,$STR_EPOCH_ACTION_SNAP_FRONT},
			{-1.31,0,0.1265,$STR_EPOCH_ACTION_SNAP_LEFT},
			{1.31,0,0.1265,$STR_EPOCH_ACTION_SNAP_RIGHT}
		};
		radius = 12;
	};
	...
	class MetalFloor_Half_DZ: FloorsWallsStairs {
		points[] = {
			{0,0,0,$STR_EPOCH_ACTION_SNAP_PIVOT},
			{0,-2.62,0.1265,$STR_EPOCH_ACTION_SNAP_BACK},
			{0,2.65,0.1265,$STR_EPOCH_ACTION_SNAP_FRONT},
			{-1.31,0,0.1265,$STR_EPOCH_ACTION_SNAP_LEFT},
			{1.31,0,0.1265,$STR_EPOCH_ACTION_SNAP_RIGHT}
		};
		radius = 10;
	...
	class GlassFloor_Quarter_DZ: FloorsWallsStairs {
		points[] = {
			{0,0,0,$STR_EPOCH_ACTION_SNAP_PIVOT},
			{0,-1.33,0.1265,$STR_EPOCH_ACTION_SNAP_BACK},
			{0,1.3,0.1265,$STR_EPOCH_ACTION_SNAP_FRONT},
			{-1.31,0,0.1265,$STR_EPOCH_ACTION_SNAP_LEFT},
			{1.32,0,0.1265,$STR_EPOCH_ACTION_SNAP_RIGHT}
		};
		radius = 10;
	};
	...
	class GlassFloor_Half_DZ: FloorsWallsStairs {
		points[] = {
			{0,0,0,$STR_EPOCH_ACTION_SNAP_PIVOT},
			{0,-2.63,0.1265,$STR_EPOCH_ACTION_SNAP_BACK},
			{0,2.64,0.1265,$STR_EPOCH_ACTION_SNAP_FRONT},
			{-1.34,0,0.1265,$STR_EPOCH_ACTION_SNAP_LEFT},
			{1.29,0,0.1265,$STR_EPOCH_ACTION_SNAP_RIGHT}
		};
		radius = 12;
	};
	...
	class MetalFloor4x_DZ: FloorsWallsStairs {
		...
		points[] = {
			{0,0,0,$STR_EPOCH_ACTION_SNAP_PIVOT},
			{0,-5.27,0.1265,$STR_EPOCH_ACTION_SNAP_BACK_CENTER},
			{-2.635,-5.27,0.1265,$STR_EPOCH_ACTION_SNAP_BACK_LEFT},
			{2.635,-5.27,0.1265,$STR_EPOCH_ACTION_SNAP_BACK_RIGHT},
			{0,5.27,0.1265,$STR_EPOCH_ACTION_SNAP_FRONT_CENTER},
			{-2.635,5.27,0.1265,$STR_EPOCH_ACTION_SNAP_FRONT_LEFT},
			{2.635,5.27,0.1265,$STR_EPOCH_ACTION_SNAP_FRONT_RIGHT},
			{-5.27,0,0.1265,$STR_EPOCH_ACTION_SNAP_LEFT_CENTER},
			{-5.27,-2.635,0.1265,$STR_EPOCH_ACTION_SNAP_LEFT_BACK},
			{-5.27,2.635,0.1265,$STR_EPOCH_ACTION_SNAP_LEFT_FRONT},
			{5.27,0,0.1265,$STR_EPOCH_ACTION_SNAP_RIGHT_CENTER},
			{5.27,-2.635,0.1265,$STR_EPOCH_ACTION_SNAP_RIGHT_BACK},
			{5.27,2.635,0.1265,$STR_EPOCH_ACTION_SNAP_RIGHT_FRONT}
		};
	};
