...
class GLT_M300_ST_DZE : GLT_M300_ST {
	...
	class Upgrades {
		ItemORP[] = {"GLT_M300_ST_DZE1",{"ItemToolbox"},{},{{"ItemORP",1},{"PartEngine",1},{"PartWheel",4},{"ItemScrews",2}}};
	};
};

class GLT_M300_ST_DZE1: GLT_M300_ST_DZE {
	displayname = "$STR_VEH_NAME_SEDAN_TAXI+";
	original = "GLT_M300_ST_DZE";
	maxspeed = 160; // car 110
	terrainCoef = 2;

	class Upgrades {
		ItemAVE[] = {"GLT_M300_ST_DZE2",{"ItemToolbox"},{},{{"ItemAVE",1},{"PartGeneric",6},{"ItemScrews",4}}};
	};
};

class GLT_M300_ST_DZE2: GLT_M300_ST_DZE1 {
	displayname = "$STR_VEH_NAME_SEDAN_TAXI++";
	armor = 55; // car 20
	...
	class Upgrades {
		ItemLRK[] = {"GLT_M300_ST_DZE3",{"ItemToolbox"},{},{{"ItemLRK",1},{"PartGeneric",2},{"ItemWoodCrateKit",1},{"ItemGunRackKit",1},{"ItemScrews",2}}};
	};
};

class GLT_M300_ST_DZE3: GLT_M300_ST_DZE2 {
	displayname = "$STR_VEH_NAME_SEDAN_TAXI+++";
	transportMaxWeapons = 20;  // car 10
	transportMaxMagazines = 100; // car 50
    transportmaxbackpacks = 4; // car 2
	...
	class Upgrades {
		ItemTNK[] = {"GLT_M300_ST_DZE4",{"ItemToolbox"},{},{{"ItemTNK",1},{"PartGeneric",2},{"PartFueltank",1},{"ItemJerrycan",2},{"ItemScrews",1}}};
	};
};

class GLT_M300_ST_DZE4: GLT_M300_ST_DZE3 {
	displayname = "$STR_VEH_NAME_SEDAN_TAXI++++";
	fuelCapacity = 210; // car 100
};
