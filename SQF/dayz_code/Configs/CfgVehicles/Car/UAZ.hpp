...
class UAZ_Rust_DZE: UAZ_Unarmed_TK_CIV_EP1 {
	...
	class Upgrades {
		ItemORP[] = {"UAZ_Rust_DZE1",{"ItemToolbox"},{},{{"ItemORP",1},{"PartEngine",1},{"PartWheel",4},{"ItemScrews",2}}};
	};
};

class UAZ_Rust_DZE1: UAZ_Rust_DZE {
	displayName = "$STR_VEH_NAME_UAZ_RUSTY+";
	original = "UAZ_Rust_DZE";
	maxspeed = 190;
	terrainCoef = 1;

	class Upgrades {
		ItemAVE[] = {"UAZ_Rust_DZE2",{"ItemToolbox"},{},{{"ItemAVE",1 },{"PartGeneric",6},{"ItemScrews",4}}};
	};
};

class UAZ_Rust_DZE2: UAZ_Rust_DZE1 {
	displayName = "$STR_VEH_NAME_UAZ_RUSTY++";
	armor = 75; // UAZ 40
	damageResistance = 0.02099;
	class HitPoints: HitPoints {
	...
	class Upgrades {
		ItemLRK[] = {"UAZ_Rust_DZE3",{"ItemToolbox"},{},{{"ItemLRK",1},{"PartGeneric",2},{"ItemWoodCrateKit",1},{"ItemGunRackKit",1},{"ItemScrews",2}}};
	};
};

class UAZ_Rust_DZE3: UAZ_Rust_DZE2 {
	displayName = "$STR_VEH_NAME_UAZ_RUSTY+++";
	transportMaxWeapons = 20;  // car 10
	transportMaxMagazines = 100; // car 50
    transportmaxbackpacks = 9; // car 2, UAZ 7
	...
	class Upgrades {
		ItemTNK[] = {"UAZ_Rust_DZE4",{"ItemToolbox"},{},{{"ItemTNK",1},{"PartGeneric",2},{"PartFueltank",1},{"ItemJerrycan",2},{"ItemScrews",1}}};
	};
};

class UAZ_Rust_DZE4: UAZ_Rust_DZE3 {
	displayName = "$STR_VEH_NAME_UAZ_RUSTY++++";
	fuelCapacity = 210; // car 100
};
...
class UAZ_WINTER_DZE: UAZ_Unarmed_TK_EP1 {
	...
	class Upgrades {
		ItemORP[] = {"UAZ_WINTER_DZE1",{"ItemToolbox"},{},{{"ItemORP",1},{"PartEngine",1},{"PartWheel",4},{"ItemScrews",2}}};
	};
};

class UAZ_WINTER_DZE1: UAZ_WINTER_DZE {
	displayName = "$STR_VEH_NAME_UAZ_WINTER+";
	original = "UAZ_WINTER_DZE";
	maxspeed = 190;
	terrainCoef = 1;

	class Upgrades {
		ItemAVE[] = {"UAZ_WINTER_DZE2",{"ItemToolbox"},{},{{"ItemAVE",1 },{"PartGeneric",6},{"ItemScrews",4}}};
	};
};

class UAZ_WINTER_DZE2: UAZ_WINTER_DZE1 {
	displayName = "$STR_VEH_NAME_UAZ_WINTER++";
	armor = 75; // UAZ 40
	damageResistance = 0.02099;
	class HitPoints: HitPoints {
	...
	class Upgrades {
		ItemLRK[] = {"UAZ_WINTER_DZE3",{"ItemToolbox"},{},{{"ItemLRK",1},{"PartGeneric",2},{"ItemWoodCrateKit",1},{"ItemGunRackKit",1},{"ItemScrews",2}}};
	};
};

class UAZ_WINTER_DZE3: UAZ_WINTER_DZE2 {
	displayName = "$STR_VEH_NAME_UAZ_WINTER+++";
	transportMaxWeapons = 20;  // car 10
	transportMaxMagazines = 100; // car 50
    transportmaxbackpacks = 9; // car 2, UAZ 7
	...
	class Upgrades {
		ItemTNK[] = {"UAZ_WINTER_DZE4",{"ItemToolbox"},{},{{"ItemTNK",1},{"PartGeneric",2},{"PartFueltank",1},{"ItemJerrycan",2},{"ItemScrews",1}}};
	};
};

class UAZ_WINTER_DZE4: UAZ_WINTER_DZE3 {
	displayName = "$STR_VEH_NAME_UAZ_WINTER++++";
	fuelCapacity = 210; // car 100
};