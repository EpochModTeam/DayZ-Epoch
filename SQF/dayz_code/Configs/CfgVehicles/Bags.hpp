...
class Patrol_Pack_DZE1 : DZ_Patrol_Pack_EP1 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','Patrol_Pack_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class Patrol_Pack_DZE2 : Patrol_Pack_DZE1 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','Patrol_Pack_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class Czech_Vest_Pouch_DZE1 : DZ_Czech_Vest_Pouch 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','Czech_Vest_Pouch_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class Czech_Vest_Pouch_DZE2 : Czech_Vest_Pouch_DZE1 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','Czech_Vest_Pouch_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class Assault_Pack_DZE1 : DZ_Assault_Pack_EP1 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','Assault_Pack_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class Assault_Pack_DZE2 : Assault_Pack_DZE1 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','Assault_Pack_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class TerminalPack_DZE1 : DZ_TerminalPack_EP1 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','TerminalPack_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class TerminalPack_DZE2 : TerminalPack_DZE1 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','TerminalPack_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class TinyPack_DZE1 : Bag_Base_EP1 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','TinyPack_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class TinyPack_DZE2 : TinyPack_DZE1 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','TinyPack_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class ALICE_Pack_DZE1 : DZ_ALICE_Pack_EP1 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','ALICE_Pack_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class ALICE_Pack_DZE2 : ALICE_Pack_DZE1 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','ALICE_Pack_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class TK_Assault_Pack_DZE1 : DZ_TK_Assault_Pack_EP1 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','TK_Assault_Pack_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class TK_Assault_Pack_DZE2 : TK_Assault_Pack_DZE1 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','TK_Assault_Pack_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class CompactPack_DZE1 : DZ_CompactPack_EP1 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CompactPack_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class CompactPack_DZE2 : CompactPack_DZE1 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CompactPack_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class British_ACU_DZE1 : DZ_British_ACU 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','British_ACU_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class British_ACU_DZE2 : British_ACU_DZE1 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','British_ACU_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class GunBag_DZE1 : DZ_GunBag_EP1 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','GunBag_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class GunBag_DZE2 : GunBag_DZE1 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','GunBag_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class NightPack_DZE1 : Bag_Base_EP1 		//new ice apo resistance mod backpack
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','NightPack_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};
};
class NightPack_DZE2 : NightPack_DZE1 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','NightPack_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class SurvivorPack_DZE1 : Bag_Base_EP1 		//new ice apo resistance mod backpack
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','SurvivorPack_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};
};
class SurvivorPack_DZE2 : SurvivorPack_DZE1 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','SurvivorPack_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class CzechBackpack_DZE1 : DZ_CivilBackpack_EP1 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class CzechBackpack_DZE2 : CzechBackpack_DZE1 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class CzechBackpack_OD_DZE1 : Bag_Base_EP1 		//new LEN mod Czech Pack variants
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_OD_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};
};
class CzechBackpack_OD_DZE2 : CzechBackpack_OD_DZE1 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_OD_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class CzechBackpack_DES_DZE1 : CzechBackpack_OD_DZE1 		//new LEN mod Czech Pack variants
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_DES_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};
};
...
class CzechBackpack_3DES_DZE1 : CzechBackpack_OD_DZE1 		//new LEN mod Czech Pack variants
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_3DES_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};
};
...
class CzechBackpack_WDL_DZE1 : CzechBackpack_OD_DZE1 		//new LEN mod Czech Pack variants
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_WDL_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};
};
...
class CzechBackpack_MAR_DZE1 : CzechBackpack_OD_DZE1 		//new LEN mod Czech Pack variants
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_MAR_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};
};
class CzechBackpack_MAR_DZE2 : CzechBackpack_OD_DZE2 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_MAR_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class CzechBackpack_DMAR_DZE1 : CzechBackpack_OD_DZE1 		//new LEN mod Czech Pack variants
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_DMAR_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};
};
class CzechBackpack_DMAR_DZE2 : CzechBackpack_OD_DZE2 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_DMAR_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class CzechBackpack_UCP_DZE1 : CzechBackpack_OD_DZE1 		//new LEN mod Czech Pack variants
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_UCP_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};
};
class CzechBackpack_UCP_DZE2 : CzechBackpack_OD_DZE2 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_UCP_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class CzechBackpack_6DES_DZE1 : CzechBackpack_OD_DZE1 		//new LEN mod Czech Pack variants
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_6DES_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};
};
class CzechBackpack_6DES_DZE2 : CzechBackpack_OD_DZE2 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_6DES_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class CzechBackpack_TAK_DZE1 : CzechBackpack_OD_DZE1 		//new LEN mod Czech Pack variants
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_TAK_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};
};
class CzechBackpack_TAK_DZE2 : CzechBackpack_OD_DZE2 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_TAK_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class CzechBackpack_NVG_DZE1 : CzechBackpack_OD_DZE1 		//new LEN mod Czech Pack variants
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_NVG_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};
};
class CzechBackpack_NVG_DZE2 : CzechBackpack_OD_DZE2
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_NVG_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class CzechBackpack_BLK_DZE1 : CzechBackpack_OD_DZE1 		//new LEN mod Czech Pack variants
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_BLK_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};
};
class CzechBackpack_BLK_DZE2 : CzechBackpack_OD_DZE2 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_BLK_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class CzechBackpack_DPM_DZE1 : CzechBackpack_OD_DZE1 		//new LEN mod Czech Pack variants
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_DPM_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};
};
class CzechBackpack_DPM_DZE2 : CzechBackpack_OD_DZE2 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_DPM_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class CzechBackpack_FIN_DZE1 : CzechBackpack_OD_DZE1 		//new LEN mod Czech Pack variants
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_FIN_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};
};
class CzechBackpack_FIN_DZE2 : CzechBackpack_OD_DZE2 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_FIN_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class CzechBackpack_MTC_DZE1 : CzechBackpack_OD_DZE1 		//new LEN mod Czech Pack variants
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_MTC_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};
};
class CzechBackpack_MTC_DZE2 : CzechBackpack_OD_DZE2 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_MTC_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class CzechBackpack_NOR_DZE1 : CzechBackpack_OD_DZE1 		//new LEN mod Czech Pack variants
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_NOR_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};
};
class CzechBackpack_NOR_DZE2 : CzechBackpack_OD_DZE2 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_NOR_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class CzechBackpack_WIN_DZE1 : CzechBackpack_OD_DZE1 		//new LEN mod Czech Pack variants
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_WIN_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};
};
class CzechBackpack_WIN_DZE2 : CzechBackpack_OD_DZE2 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_WIN_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class CzechBackpack_ATC_DZE1 : CzechBackpack_OD_DZE1 		//new LEN mod Czech Pack variants
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_ATC_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};
};
class CzechBackpack_ATC_DZE2 : CzechBackpack_OD_DZE2 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_ATC_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class CzechBackpack_MTL_DZE1 : CzechBackpack_OD_DZE1 		//new LEN mod Czech Pack variants
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_MTL_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};
};
class CzechBackpack_MTL_DZE2 : CzechBackpack_OD_DZE2 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_MTL_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class CzechBackpack_FTN_DZE1 : CzechBackpack_OD_DZE1 		//new LEN mod Czech Pack variants
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_FTN_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};
};
class CzechBackpack_FTN_DZE2 : CzechBackpack_OD_DZE2 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CzechBackpack_FTN_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class WandererBackpack_DZE1 : Bag_Base_EP1 		//new ice apo resistance mod backpack
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','WandererBackpack_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};
};
class WandererBackpack_DZE2 : WandererBackpack_DZE1 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','WandererBackpack_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
...
{		
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','LegendBackpack_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};
};
class LegendBackpack_DZE2 : LegendBackpack_DZE1 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','LegendBackpack_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class CoyoteBackpack_DZE1 : DZ_Backpack_EP1 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CoyoteBackpack_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
...
class CoyoteBackpackDes_DZE1: CoyoteBackpack_DZE1		//new KSK mod coyote backpack variant
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CoyoteBackpackDes_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};
};
class CoyoteBackpackDes_DZE2 : CoyoteBackpack_DZE2 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CoyoteBackpackDes_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class CoyoteBackpackWdl_DZE1: CoyoteBackpack_DZE1		//new KSK mod coyote backpack variant
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CoyoteBackpackWdl_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};
};
class CoyoteBackpackWdl_DZE2 : CoyoteBackpack_DZE2 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','CoyoteBackpackWdl_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class LargeGunBag_DZE1 : DZ_LargeGunBag_EP1 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','LargeGunBag_DZE1'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};
class LargeGunBag_DZE2 : LargeGunBag_DZE1 
{
	...
	class eventHandlers
	{
		init="[(_this select 0),'CfgVehicles','LargeGunBag_DZE2'] execVM '\z\addons\dayz_code\init\object_BackpackAction.sqf';";
	};	
};