...
class Misc_Backpackheap : Strategic 
{
	scope = 2;
...
class Land_Misc_Rubble_EP1 : Strategic
{
	scope = 2;
...
class MAP_rubble_metal_plates_01 : Strategic
{
	scope = 2;
...
class MAP_rubble_metal_plates_03 : Strategic
{
	scope = 2;
...
class MAP_rubble_bricks_01 : Strategic
{
	scope = 2;
...
class MAP_rubble_metal_plates_04 : Strategic
{
	scope = 2;
...
class Land_Misc_Garb_Heap_EP1 : Strategic
{
	scope = 2;
...
class MAP_rubble_wood_01 : Strategic
{
	scope = 2;
...
class MAP_rubble_wood_02 : Strategic
{
	scope = 2;
...
class MAP_Misc_TyreHeap : Strategic
{
	scope = 2;
