...
class Land_a_stationhouse : Military
{
	...
	lootChance = 0.3;
	lootPos[] = {
		//{-2.7,-7.57,-9.46},{-0.89,-5.72,-9.47},{-3.24,-6.62,-4.65},{-1.36,-8.36,-4.65},{-1.71,-7.85,-0.04},{-3.39,-7.88,-0.04},{-1.4,-7.8,4.41},{-1.38,-5.79,4.41},{1.51,1.96,-9.47},{18.91,-4.07,-9.47},{-14.4,3.29,-0.51},{1.33,0.89,-0.51},{-2.4,-6.64,8.49},
...
class Land_Mil_ControlTower: Military
{
	...
	lootChance = 0.4;
	lootPos[] = {
		//{10.0703,3.76367,-9.62869},{3.85254,3.53516,-5.50372},{1.75195,5.68164,-5.51373},{6.66113,-0.625488,-1.0787},{2.63965,-0.191406,-1.0687},{6.72266,3.23389,-1.0787},
