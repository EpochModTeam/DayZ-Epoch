...
class Land_HouseV2_01A_DZE: Residential {
	zedPos[] = {{-2.21313,-3.28174,-4.79521}};
	lootPos[] = {{-0.260742,4.55664,-5.53115},{-7.47949,4.35547,-5.53115},{-7.28418,-0.263672,-5.53115},{3.33398,3.40625,-5.53115},{8.4209,4.28906,-5.53115},{7.93652,-1.16211,-5.53115},{-2.28418,1.91016,-5.53115}};
	lootPosSmall[] = {{-0.233398,-1.94727,-5.53115},{-0.643555,-3.51758,-5.57115},{-3.53223,-3.58398,-5.54115}};
};
...
class Land_HouseBlock_A2_1_DZE: Residential {
	zedPos[] = {{6,-4.3,-6.6},{3.2,-1.1,-6.6}};
	lootPos[] = {{7.17188,2.44141,-7.014},{3.51172,-4.26978,-7.014},{2.7793,2.7085,-7.014}};
	lootPosSmall[] = {{7.42676,-4.66772,-7.014},{3.5918,3.08154,-6.644}};
};

class Land_HouseBlock_A3: Residential {
	zedPos[] = {{5.8,-3.8,-4.8},{0.8,0,-5}};
	lootPos[] = {{0.0146484,-4.47217,-5.5},{-0.410156,3.3833,-5.5},{6.24902,2.9834,-5.048},{2.72754,2.96533,-5.048},{3.21875,-3.45215,-5.048}};
	lootPosSmall[] = {{3.5791,3.42773,-4.66852},{7.40039,-4.3916,-5.048}};
};
