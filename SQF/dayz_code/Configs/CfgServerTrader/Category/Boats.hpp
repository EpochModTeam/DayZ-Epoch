...
class Category_49 {
	...
	class JetSkiYanahui_Case_Blue {type = "trade_any_boat";buy[] = {6,"ItemGoldBar"};sell[] = {3,"ItemGoldBar"};};
	class SeaFox_DZE {type = "trade_any_boat";buy[] = {-2,"ItemBriefcase100oz"};sell[] = {1,"ItemBriefcase100oz"};};	
};