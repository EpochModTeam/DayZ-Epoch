...
class Category_47 {
	...
	class pook_H13_civ_black {type = "trade_any_vehicle";buy[] =  {1,"ItemBriefcase100oz"};sell[] = {6,"ItemGoldBar10oz"};};
	class pook_H13_medevac {type = "trade_any_vehicle";buy[] =  {1,"ItemBriefcase100oz"};sell[] = {6,"ItemGoldBar10oz"};};
