class Category_50 {
	class bulk_17Rnd_9x19_glock17 {type = "trade_items";buy[] = {2,"ItemGoldBar"};sell[] = {1,"ItemGoldBar"};};
	class bulk_15Rnd_9x19_M9SD {type = "trade_items";buy[] = {2,"ItemGoldBar"};sell[] = {1,"ItemGoldBar"};};
	class bulk_30Rnd_9x19_MP5SD {type = "trade_items";buy[] = {3,"ItemGoldBar"};sell[] = {3,"ItemGoldBar"};};
	class bulk_30Rnd_556x45_StanagSD {type = "trade_items";buy[] = {4,"ItemGoldBar"};sell[] = {4,"ItemGoldBar"};};
	class bulk_ItemSandbag {type = "trade_items";buy[] = {3,"ItemGoldBar10oz"};sell[] = {3,"ItemGoldBar10oz"};};
	class bulk_ItemTankTrap {type = "trade_items";buy[] = {2,"ItemGoldBar"};sell[] = {2,"ItemGoldBar"};};
	class bulk_ItemWire {type = "trade_items";buy[] = {5,"ItemSilverBar10oz"};sell[] = {5,"ItemSilverBar10oz"};};
