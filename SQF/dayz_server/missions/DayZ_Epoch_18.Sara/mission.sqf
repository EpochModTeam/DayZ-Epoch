...
if (true) then
{
  _this = createAgent ["Profiteer4", [11462.399, 11365.393, -9.1552734e-005], [], 0, "CAN_COLLIDE"];
  _unit_13 = _this;
...
if (true) then
{
  _this = createAgent ["Worker3", [4059.3704, 11682.107, 0.22387695], [], 0, "CAN_COLLIDE"];
  _unit_56 = _this;
...
if (true) then
{
  _this = createAgent ["CIV_EuroMan01_EP1", [4072.6628, 11687.947, -0.038146973], [], 0, "CAN_COLLIDE"];
  _unit_57 = _this;
...
if (true) then
{
  _this = createAgent ["RU_WorkWoman5", [4054.1255, 11670.723, 0.54440308], [], 0, "CAN_COLLIDE"];
  _unit_58 = _this;
...
if (true) then
{
  _this = createAgent ["CIV_EuroMan02_EP1", [4066.6404, 11686.604, 0.33944702], [], 0, "CAN_COLLIDE"];
  _unit_60 = _this;
...
if (true) then
{
  _this = createAgent ["Woodlander1", [11450.503, 11353.635, -9.1552734e-005], [], 0, "CAN_COLLIDE"];
  _unit_74 = _this;
...
if (true) then
{
  _this = createAgent ["RU_WorkWoman1", [11454.922, 11355.044, 0.94462103], [], 0, "CAN_COLLIDE"];
  _unit_75 = _this;
...
if (true) then
{
  _this = createAgent ["Rocker4", [11456.184, 11359.277], [], 0, "CAN_COLLIDE"];
  _unit_78 = _this;
...
if (true) then
{
  _this = createAgent ["RU_Citizen3", [11453.29, 11373.179, 3.0517578e-005], [], 0, "CAN_COLLIDE"];
  _unit_79 = _this;
...
if (true) then
{
  _this = createAgent ["Dr_Annie_Baker_EP1", [11455.903, 11376.358], [], 0, "CAN_COLLIDE"];
  _unit_82 = _this;
...
if (true) then
{
  _this = createAgent ["Pilot_EP1", [6317.0498, 7797.918, 3.0517578e-005], [], 0, "CAN_COLLIDE"];
  _unit_94 = _this;
...
if (true) then
{
  _this = createAgent ["GUE_Soldier_MG", [1606.5773, 7806.395, 0.25734121], [], 0, "CAN_COLLIDE"];
  _unit_108 = _this;
...
if (true) then
{
  _this = createAgent ["RU_Profiteer4", [6301.9575, 7803.8789], [], 0, "CAN_COLLIDE"];
  _unit_118 = _this;
