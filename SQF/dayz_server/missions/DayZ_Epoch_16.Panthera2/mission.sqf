...
if (true) then
{
  _this = _group_2 createUnit ["UN_CDF_Soldier_MG_EP1", [5229.5488, 8228.6309, 0.11357399], [], 0, "CAN_COLLIDE"];
  _unit_65 = _this;
...
if (true) then
{
  _this = _group_1 createUnit ["Rita_Ensler_EP1", [4329.2837, 6316.9658, 1.021734], [], 0, "CAN_COLLIDE"];
  _unit_187 = _this;
...
if (true) then
{
  _this = _group_1 createUnit ["ValentinaVictim", [4329.7354, 6320.0952, 1.0539727], [], 0, "CAN_COLLIDE"];
  _unit_193 = _this;
...
if (true) then
{
  _this = _group_0 createUnit ["USMC_SoldierS_Engineer", [4341.6519, 6319.353, -1.5258789e-005], [], 0, "CAN_COLLIDE"];
  _unit_202 = _this;
...
if (true) then
{
  _this = _group_0 createUnit ["USMC_Soldier_TL", [4338.6743, 6319.2251, -7.6293945e-006], [], 0, "CAN_COLLIDE"];
  _unit_204 = _this;
...
if (true) then
{
  _this = _group_2 createUnit ["Reynolds_PMC", [4322.5977, 6313.9746, -2.2888184e-005], [], 0, "CAN_COLLIDE"];
  _unit_205 = _this;
...
if (true) then
{
  _this = _group_0 createUnit ["FR_Corpsman", [2240.3418, 9481.8193, 2.6702881e-005], [], 0, "CAN_COLLIDE"];
  _unit_213 = _this;
...
if (true) then
{
  _this = _group_2 createUnit ["GUE_Soldier_AR", [2236.7632, 9477.0029, 1.5258789e-005], [], 0, "CAN_COLLIDE"];
  _unit_216 = _this;
