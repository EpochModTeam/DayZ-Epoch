...
if (true) then
{
  _this = _group_0 createUnit ["Doctor", [15295.845, 9287.3516, 1.7166138e-005], [], 0, "CAN_COLLIDE"];
  _unit_14 = _this;
...
if (true) then
{
  _this = _group_0 createUnit ["Soldier_Sniper_KSVK_PMC", [15318.384, 9304.9199, -4.7683716e-005], [], 0, "CAN_COLLIDE"];
  _unit_17 = _this;
...
if (true) then
{
  _this = _group_0 createUnit ["Soldier_GL_PMC", [15313.905, 9304.9209, -5.7220459e-006], [], 0, "CAN_COLLIDE"];
  _unit_20 = _this;
...
if (true) then
{
  _this = _group_0 createUnit ["Rocker4", [15319.325, 9260.5137, 1.7166138e-005], [], 0, "CAN_COLLIDE"];
  _unit_22 = _this;
...
if (true) then
{
  _this = _group_0 createUnit ["Citizen3", [15299.092, 9303.5088, 1.6212463e-005], [], 0, "CAN_COLLIDE"];
  _unit_23 = _this;
...
if (true) then
{
  _this = _group_0 createUnit ["RU_Worker4", [15306.199, 9303.7803, 2.9563904e-005], [], 0, "CAN_COLLIDE"];
  _unit_24 = _this;
...
_this = createMarker ["", [15309.663, 9278.4912, -14.993002]];
...
if (true) then
{
  _this = _group_0 createUnit ["Ins_Soldier_GL_DZ", [15336.184, 9301.21, 2.8610229e-005], [], 0, "CAN_COLLIDE"];
  _unit_25 = _this;
  _this setDir -143.76357;
  _this setUnitAbility 0.60000002;
  if (false) then {_group_0 selectLeader _this;};
};
