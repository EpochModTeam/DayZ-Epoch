...
if (true) then
{
  _this = _group_0 createUnit ["GUE_Woodlander1", [10938.677, 651.23663, -3.0517578e-005], [], 0, "CAN_COLLIDE"];
  _unit_0 = _this;
...
if (true) then
{
  _this = _group_0 createUnit ["RU_Worker1", [10966.954, 654.58276, 0.97554183], [], 0, "CAN_COLLIDE"];
  _unit_1 = _this;
...
if (true) then
{
  _this = _group_0 createUnit ["RU_Farmwife5", [10954.223, 658.16821, 0.22649978], [], 0, "CAN_COLLIDE"];
  _unit_2 = _this;
...
if (true) then
{
  _this = _group_0 createUnit ["Dr_Hladik_EP1", [10958.092, 663.19617, 2.0027161e-005], [], 0, "CAN_COLLIDE"];
  _unit_4 = _this;
...
_this = createMarker ["", [10948.426, 654.90265, -10.727827]];
