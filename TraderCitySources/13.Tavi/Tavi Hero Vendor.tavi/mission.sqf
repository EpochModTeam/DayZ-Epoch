...
if (true) then
{
  _this = _group_0 createUnit ["Soldier_Sniper_PMC", [15598.164, 16402.732, -7.6293945e-006], [], 0, "CAN_COLLIDE"];
  _unit_0 = _this;
...
if (true) then
{
  _this = _group_0 createUnit ["RU_Damsel5", [15595.011, 16378.547, 0.10890254], [], 0, "CAN_COLLIDE"];
  _unit_1 = _this;
...
if (true) then
{
  _this = _group_0 createUnit ["RU_Doctor", [15576.031, 16377.422, 1.1444092e-005], [], 0, "CAN_COLLIDE"];
  _unit_2 = _this;
...
if (true) then
{
  _this = _group_0 createUnit ["GUE_Woodlander3", [15579.386, 16376.245], [], 0, "CAN_COLLIDE"];
  _unit_4 = _this;
  _this setUnitAbility 0.60000002;
  if (false) then {_group_0 selectLeader _this;};
};
...
_this = createMarker ["", [15587.822, 16394.049, -35.599998]];
