...
if (true) then
{
  _this = createVehicle ["sigisolda6", [3994.8784, 2758.1152, 0.21266335], [], 0, "CAN_COLLIDE"];
  _vehicle_253 = _this;
  _this setDir -50.014053;
  _this setVehicleLock "LOCKED";
  _this setPos [3994.8784, 2758.1152, 0.21266335];
};
...
if (true) then
{
  _this = _group_0 createUnit ["BAF_Soldier_AA_W", [4022.1843, 2891.9211], [], 0, "CAN_COLLIDE"];
  _unit_55 = _this;
  _this setDir 217.9931;
  _this setUnitAbility 0.60000002;
