...
if (true) then
{
  _this = _group_0 createUnit ["BAF_Soldier_AA_MTP", [6340.6621, 7807.7246], [], 0, "CAN_COLLIDE"];
  _unit_67 = _this;
  _this setUnitAbility 0.60000002;
...
if (true) then
{
  _this = _group_0 createUnit ["BAF_Soldier_AA_MTP", [6343.7993, 7805.2061, -6.1035156e-005], [], 0, "CAN_COLLIDE"];
  _unit_69 = _this;
  _this setUnitAbility 0.60000002;
  if (true) then {_group_0 selectLeader _this;};
  if (true) then {selectPlayer _this;};
