...
if (true) then
{
  _this = _group_0 createUnit ["Profiteer1", [5552.4077, 8770.1514, -3.8146973e-006], [], 0, "CAN_COLLIDE"];
  _unit_0 = _this;
...
if (true) then
{
  _this = _group_0 createUnit ["RU_Worker4", [5542.8452, 8758.9189, 3.0517578e-005], [], 0, "CAN_COLLIDE"];
  _unit_1 = _this;
...
if (true) then
{
  _this = _group_0 createUnit ["Citizen3", [5538.1587, 8755.9873, -2.2888184e-005], [], 0, "CAN_COLLIDE"];
  _unit_2 = _this;
...
if (true) then
{
  _this = _group_0 createUnit ["Soldier_Sniper_KSVK_PMC", [5531.3525, 8754.4307, 1.1444092e-005], [], 0, "CAN_COLLIDE"];
  _unit_3 = _this;
...
if (true) then
{
  _this = _group_0 createUnit ["Soldier_GL_PMC", [5528.4814, 8753.5547, 1.1444092e-005], [], 0, "CAN_COLLIDE"];
  _unit_4 = _this;
...
if (true) then
{
  _this = _group_0 createUnit ["Doctor", [5523.5796, 8750.2285, 3.8146973e-006], [], 0, "CAN_COLLIDE"];
  _unit_5 = _this;
