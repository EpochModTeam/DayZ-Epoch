...
if (true) then
{
  _this = _group_0 createUnit ["GUE_Soldier_2", [13340.847, 8610.9043], [], 0, "CAN_COLLIDE"];
  _unit_0 = _this;
...
if (true) then
{
  _this = _group_0 createUnit ["Reynolds_PMC", [9864.4287, 7471.3115, 1.5258789e-005], [], 0, "CAN_COLLIDE"];
  _unit_2 = _this;
...
_this = createMarker ["", [9859.4209, 7471.5684, -173.54755]];
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
_marker_2 = _this;

_this = createMarker ["", [13342.758, 8611.9932, -172.991]];
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
_marker_3 = _this;
